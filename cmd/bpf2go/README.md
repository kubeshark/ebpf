...
Invoke the program using go generate:
    ...
    //go:generate go run github.com/kubeshark/ebpf/cmd/bpf2go foo path/to/src.c -- -I/path/to/include
...
across a project, e.g. to set specific C flags:
    ...
    //go:generate go run github.com/kubeshark/ebpf/cmd/bpf2go -cflags "$BPF_CFLAGS" foo path/to/src.c
